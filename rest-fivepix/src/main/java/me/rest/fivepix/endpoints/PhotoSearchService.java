 ...
 */
public class PhotoSearchService implements PhotoItemExtractor {
     ...
     */
    public PhotoSearchService(String serviceURL, String consumerKey, int pageSize, boolean shuffle) {
